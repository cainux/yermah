/*jslint white: true, onevar: true, undef: true, nomen: true, plusplus: true, bitwise: true, regexp: true, newcap: true, indent: 4 */
...
var Yermah = function () {
    ...
    this.maximumInterval = 1000 * 60 * 5; // 5 minutes
